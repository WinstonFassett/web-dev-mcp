module.exports = [
"[project]/packages/next-live-dev-mcp/dist/client/index.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$next$2d$live$2d$dev$2d$mcp$2f$node_modules$2f$capnweb$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/next-live-dev-mcp/node_modules/capnweb/dist/index.js [app-rsc] (ecmascript)");
;
;
// Only run in browser
...
"[project]/test-app-nextjs/app/layout.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$test$2d$app$2d$nextjs$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/test-app-nextjs/node_modules/next/dist/server/route-modules/app-page/vendored/rsc/react-jsx-dev-runtime.js [app-rsc] (ecmascript)");
// Import MCP client for browser instrumentation
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$next$2d$live$2d$dev$2d$mcp$2f$dist$2f$client$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/next-live-dev-mcp/dist/client/index.js [app-rsc] (ecmascript)");
;
;
const metadata = {
...
function RootLayout({ children }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$test$2d$app$2d$nextjs$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("html", {
        lang: "en",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$test$2d$app$2d$nextjs$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("body", {
            children: children
        }, void 0, false, {
            fileName: "[project]/test-app-nextjs/app/layout.tsx",
            lineNumber: 16,
            columnNumber: 7
        }, this)
    }, void 0, false, {
...
"[project]/test-app-nextjs/app/layout.tsx [app-rsc] (ecmascript, Next.js Server Component)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/test-app-nextjs/app/layout.tsx [app-rsc] (ecmascript)"));
}),
"[project]/test-app-nextjs/node_modules/next/dist/server/route-modules/app-page/vendored/rsc/react-jsx-dev-runtime.js [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

module.exports = __turbopack_context__.r("[project]/test-app-nextjs/node_modules/next/dist/server/route-modules/app-page/module.compiled.js [app-rsc] (ecmascript)").vendored['react-rsc'].ReactJsxDevRuntime;
}),
"[project]/packages/next-live-dev-mcp/node_modules/capnweb/dist/index.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    ()=>newMessagePortRpcSession2,
    "newWebSocketRpcSession",
    ()=>newWebSocketRpcSession2,
...
var DISPOSED_HOOK = new ErrorStubHook(new Error("Attempted to use RPC stub after it has been disposed."));
...
var PROXY_HANDLERS = {
    ...
    get (target, prop, receiver) {
        ...
        if (prop === RAW_STUB) {
            ...
            return new RpcPromise(stub.hook, stub.pathIfPromise ? [
                ...stub.pathIfPromise,
                prop
            ] : [
                prop
...
var Devaluator = class _Devaluator {
    ...
    devaluateImpl(value, parent, depth) {
        if (depth >= 64) {
            throw new Error("Serialization exceeded maximum allowed depth. (Does the message contain cycles?)");
        }
        let kind = typeForRpc(value);
        switch(kind){
            case "unsupported":
...
function fixBrokenRequestBody(request, body) {
    let promise = new Response(body).arrayBuffer().then((arrayBuffer)=>{
        ...
        let result = new Request(request, {
            body: bytes
        });
...
var RpcSessionImpl = class {
    ...
    importPromise(idx) {
        if (this.abortReason) throw this.abortReason;
        if (this.imports[idx]) {
            return new ErrorStubHook(new Error("Bug in RPC system: The peer sent a promise reusing an existing export ID."));
        }
    ...
    sendStream(id, path, args) {
        ...
        this.imports.push(entry);
        let promise = entry.awaitResolution().then((p)=>{
            p.dispose();
    ...
    async readLoop(abortPromise) {
        while(!this.abortReason){
            let msg = JSON.parse(await Promise.race([
...
var WritableStreamStubHook = class _WritableStreamStubHook extends StubHook {
    ...
    static create(stream) {
        ...
        return new _WritableStreamStubHook({
            refcount: 1,
            writer,
            closed: false
        });
...
function createWritableStreamFromHook(hook) {
    ...
    return new WritableStream({
        write (chunk, controller) {
            ...
            const { promise, size } = hook.stream([
                "write"
            ], payload);
            if (size === void 0) {
            ...
            if (--state.refcount === 0) {
                if (!state.canceled) {
                    ...
                    if (!state.stream.locked) {
                        state.stream.cancel(new Error("ReadableStream RPC stub was disposed without being consumed")).catch(()=>{});
                    }
                }
            }
        }
...
//# sourceMappingURL=_0_q63sq._.js.map